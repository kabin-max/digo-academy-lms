            ...
            {categories.map((category, index) => {
              ...
              return (
                <StaggerItem key={category.id}>
                  <div className="group relative flex h-full items-center gap-3 overflow-hidden rounded-2xl bg-card p-4 shadow-sm ring-1 ring-border/60 transition-all duration-300 hover:-translate-y-1 hover:shadow-lg hover:ring-brand-blue/30">
                    <span
                      className={cn(
          ...
          <div className="relative flex flex-col items-center gap-4 overflow-hidden rounded-3xl bg-linear-to-br from-slate-900 via-brand-blue to-indigo-800 px-6 py-14 text-center text-white">
            ...
            <div className="relative mt-2 flex flex-wrap justify-center gap-3">
              <Button
                ...
                nativeButton={false}
                render={<Link href="/register">Get started now</Link>}
              />
              <Button
                size="lg"
                variant="outline"
